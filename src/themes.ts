...
export const themes: Theme[] = [
  {
    ...
    nav: {
      ...
      itemActive: 'bg-[#7B98B8] text-white shadow-md shadow-[#7B98B8]/20',
      itemActiveProfile: 'bg-[#0F172A] text-white shadow-md shadow-[#0F172A]/20',
      itemHover: 'hover:text-[#7B98B8] hover:bg-[#7B98B8]/10',
