      ...
      <div className={rightCls}>
        {!calc ? (
          ...
          <>
            ...
            {/* Hero: poupança total (não Car, não Oferta) */}
            {!isOferta && !isCar && (
            ...
            {/* SS Savings (excluído para Car e Oferta) */}
            {!isOferta && !isCar && (
            ...
            {/* Comparison — ticket vs. salary (não Car) */}
            {!isCar && (
              <div className="bg-white border border-[#E2E8F0] rounded-[20px] p-5">
                <div className="flex items-center gap-3 mb-4">
            ...
            {/* Car: breakdown de custo e benefícios fiscais */}
            {isCar && (
              <div className="bg-white border border-[#E2E8F0] rounded-[20px] p-5">
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2 bg-slate-50 rounded-[10px]">
