    ...
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-4">
      <div className="bg-white rounded-[24px] p-10 shadow-xl w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-[11px] font-[700] uppercase tracking-[1px] text-[#64748B] mb-2">
              Email
            </label>
            <input
              type="email"
          ...
          <button
            type="submit"
            className="w-full bg-[#781D1D] text-white py-3.5 rounded-[10px] text-[15px] font-[700] hover:bg-[#5A1313] active:scale-[0.98] transition-all mt-2 shadow-md shadow-[#781D1D]/20"
          >
            Entrar
          </button>
        </form>
