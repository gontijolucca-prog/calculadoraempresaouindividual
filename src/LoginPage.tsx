...
export default function LoginPage({ onLogin }: Props) {
  ...
  return (
    <motion.div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-4" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.35, ease: [0.32, 0.72, 0, 1] }}>
