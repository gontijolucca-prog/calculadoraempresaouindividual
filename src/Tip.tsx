  ...
  return (
    <>
      <span
        ...
        className="inline-flex items-center justify-center w-[15px] h-[15px] rounded-full bg-slate-200 text-slate-500 text-[9px] font-[800] cursor-help hover:bg-[#0677FF] hover:text-white transition-colors select-none ml-1.5 align-middle"
      >?</span>
