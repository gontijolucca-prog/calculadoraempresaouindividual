      ...
      >
        <div className="bg-white rounded-[24px] p-8 md:p-10 shadow-xl max-w-md w-full text-center">
          ...
          <button
            ...
            className="mt-6 w-full inline-flex items-center justify-center gap-2 bg-[#0677FF] text-white py-3 rounded-[10px] text-[14px] font-[700] hover:bg-[#0556CC] ative:scale-[0.98] transition-all shadow-md shadow-[#0677FF]/20"
          >
