...
export default function LandingPage({ onEnter }: Props) {
  ...
  return (
    <div className="min-h-screen w-full bg-[#F5F7FA] text-[#0B1D2D] overflow-x-hidden">
      ...
      <Hero onEnter={() => setShowLogin(true)} parallaxY={heroParallax} fadeOpacity={heroFade} />
      <ValueStrip />
      <HowItWorks />
      <ToolsCatalog />
      <PackageBlock />
      <Compliance />
      <Pricing onEnter={() => setShowLogin(true)} />
      <FinalCTA onEnter={() => setShowLogin(true)} />
      <Footer />
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        <div className="text-center mb-6">
          <BrandMark size={48} />
          <h2 className="text-[22px] font-[800] text-[#0B1D2D] mt-4">Entrar no Estudo 360</h2>
          <p className="text-[13px] text-[#64748B] mt-1">Acesse os seus simuladores e clientes</p>
        </div>

        {error && (
          <div className="bg-red-50 border border-red-100 rounded-[10px] p-3 mb-4">
            <p className="text-[12px] text-red-700 font-[500]">{error}</p>
          </div>
        )}

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-[11px] font-[700] uppercase tracking-[1px] text-[#64748B] mb-1.5">Email</label>
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-[#F5F7FA] border-2 border-[#E2E8F0] rounded-[10px] text-[14px] font-[500] focus:border-[#0677FF] outline-none transition-colors"
          ...
          <div>
            <label className="block text-[11px] font-[700] uppercase tracking-[1px] text-[#64748B] mb-1.5">Password</label>
            <div className="relative">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 bg-[#0677FF] text-white py-3 rounded-[10px] text-[14px] font-[700] hover:bg-[#0556CC] disabled:opacity-50 transition-all"
          >
        ...
        <div className="relative my-5">
          ...
          <div className="relative flex justify-center"><span className="bg-white px-3 text-[11px] text-[#94A3B8] uppercase tracking-wider">ou</span></div>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full flex items-center justify-center gap-2 bg-white border-2 border-[#E2E8F0] text-[#0B1D2D] py-3 rounded-[10px] text-[14px] font-[700] hover:bg-[#F5F7FA] disabled:opacity-50 transition-all"
        >
        ...
        <p className="text-center text-[12px] text-[#64748B] mt-5">
          ...
          <button type="button" onClick={() => setIsSignUp(!isSignUp)} className="text-[#0677FF] font-[600] hover:underline">
