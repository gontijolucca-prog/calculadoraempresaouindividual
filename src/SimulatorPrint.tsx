...
export function SimulatorPrintButton({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <button
      ...
      className={`inline-flex shrink-0 items-center justify-center gap-1.5 rounded-[9px] border border-[#D7E2EE] bg-white px-2 py-2 text-[12px] font-[700] text-[#475569] transition-colors hover:border-[#0677FF] hover:bg-[#F5FAFF] hover:text-[#0677FF] sm:px-3 ${compact ? 'sm:px-2.5' : ''}`}
    >
