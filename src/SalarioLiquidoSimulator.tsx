          ...
          {state.irsJovem && (
            <div className="grid grid-cols-2 gap-[10px]">
              ...
              <div>
                ...
                <input type="number" min="0" max="10" value={state.anosAtividade === 0 ? '' : state.anosAtividade} onChange={e => setSt({ anosAtividade: intInput(e.target.value) })} className={inputCls} />
              </div>
            </div>
          )}
        ...
        <div className="space-y-[18px]">
          ...
          {s.irsJovem && (
            <div className="grid grid-cols-2 gap-[10px]">
              ...
              <div>
                <label className={labelCls}>Anos de atividade <Tip>Há quantos anos está a trabalhar. O benefício de IRS Jovem varia conforme o número de anos de atividade.</Tip></label>
                <input type="number" min="0" max="10" value={s.anosAtividade === 0 ? '' : s.anosAtividade} onChange={e => setState({ anosAtividade: intInput(e.target.value) })} className={inputCls} />
              </div>
            </div>
          )}
